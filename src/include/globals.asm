...
DEF RNG_MODE_I          EQU 5
DEF RNG_MODE_COUNT      EQU 6
...
DEF ROT_MODE_BARS       EQU 4
DEF ROT_MODE_COUNT      EQU 5
...
DEF SCURVE_SHRT         EQU 7
DEF SCURVE_COUNT        EQU 8
